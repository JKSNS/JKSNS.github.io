...
import { ChevronRight, ImageIcon, InfoIcon, LayoutGridIcon, Palette, SquareTerminal } from "lucide-react";
import { memo } from "react";

import { useDeviceType } from "@/os/desktop/dock/useDeviceType";

export type SettingsPanelId = "about" | "wallpaper" | "dock" | "icons" | "terminal";
...
const NAV_ITEMS: NavItem[] = [
	...
	},
	{
		id: "icons",
		label: "Icons",
		description: "Desktop icon colors",
		icon: Palette,
		iconBg: "bg-gray-600",
	},
	{
		id: "terminal",
		label: "Terminal",
		description: "Font color and appearance",
		icon: SquareTerminal,
		iconBg: "bg-gray-600",
	},
];
